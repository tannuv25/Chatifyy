            ...
            {messagesDummyData.map((msg, index) => (
                <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !== '680f50e410f3cd28382ecf9' && 'flex-row-reverse'}`}>
                    {msg.image ? (
                        ...
                        <p className={`p-2 max-w-50 md:text-sm font-light rounded-lg mb-8 break-all bg-violet-500/30 text-white ${msg.senderId === '680f50e410f3cd28382ecf9' ? 'rounded-br-none': 'rounded-bl-none'}`}>
                            {msg.text}
                        </p>
                    )}
                    <div className='text-center text-xs'>
                        ...
                        <p className='text-gray-500'>{formatMessageTimestamp(msg.createdAt)}</p>
                    </div>
                    </div>
           ) )}
                ...
                {messagesDummyData.map((msg, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Message bubble */}
                            {msg.image ? (
                                <div className="max-w-57.5 rounded-lg overflow-hidden border border-gray-700">
                                    <img
                                        src={msg.image}
                                        alt=""
                                ...
                                <p
                                    className={`p-2 max-w-60 text-sm font-light text-white rounded-lg wrap-break-word
              ${isMe
